...
public class EmpregadoRest {	
	...
	public Response listarEmpregadosAtivos() throws Exception {
		List<Empregado> listaAtivos = Banco.listarEmpregadosAtivos();		
		GenericEntity<List<Empregado>> entity = new GenericEntity<List<Empregado>>(listaAtivos) {};
		return Response.ok().entity(entity).build();
	}
	...
	public Response listarEmpregadosInativos() throws Exception {
		List<Empregado> listaInativos = Banco.listarEmpregadosInativos();		
		GenericEntity<List<Empregado>> entity = new GenericEntity<List<Empregado>>(listaInativos) {};
		return Response.ok().entity(entity).build();
	}
	@GET
	@Path("{matricula}")
