...
public class UsuarioRest {
	...
	@Path("{matricula}")
	@Produces(MediaType.APPLICATION_JSON)
	public Response buscarUsuarioPorMatricula(@PathParam("matricula") String matricula) throws Exception {
		try {
			...
			return Response.status(Status.INTERNAL_SERVER_ERROR).entity("{ \"mensagem\" : \"Falha para obter usuario!\" , \"detalhe\" :  \""+ e.getMessage() +"\"  }").build();
		}
	}
	...
	public Response incluirUsuario (Usuario usuario) {
		try {
			...
			return Response.status(Status.INTERNAL_SERVER_ERROR).entity("{ \"mensagem\" : \"Falha na inclusao do usuario!\" , \"detalhe\" :  \""+ e.getMessage() +"\"  }").build();
		}		
	}
	...
	public Response alterarUsuario(@PathParam("matricula") String matricula, Usuario usuario)  {
		try {			
			...
			return Response.status(Status.INTERNAL_SERVER_ERROR).entity("{ \"mensagem\" : \"Falha na alteracao do usuario!\" , \"detalhe\" :  \""+ e.getMessage() +"\"  }").build();
		}
	}
	...
	public Response excluirUsuario(@PathParam("matricula") String matricula) throws Exception {
		try {
			...
			return Response.status(Status.INTERNAL_SERVER_ERROR).entity("{ \"mensagem\" : \"Falha na exclusao do usuario!\" , \"detalhe\" :  \""+ e.getMessage() +"\"  }").build();
		}		
	}
